...
pub fn bad_request(msg: &str) -> Result<hyper::Response<BoxBody>, hyper::http::Error> {
    default()
...
pub fn not_found() -> Result<hyper::Response<BoxBody>, hyper::http::Error> {
    default()
...
pub fn internal_server_error(msg: &str) -> Result<hyper::Response<BoxBody>, hyper::http::Error> {
    default()
